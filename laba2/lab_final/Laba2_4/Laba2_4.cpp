            ...
            while (true) {
                ...
                case '1':
                    ...
                    try {
                        ...
                        std::cin >> value;
                        if (x_1 < 0 || y_1 < 0) {
                            image_1.rdraw_rectangle(x_1, y_1, x_2, y_2, 0, 0, value);
                        }
                        else {
                            image_1.rdraw_rectangle(x_1, y_1, x_2, y_2, x_1, y_1, value);
                        }
            ...
            while (true) {
                ...
                case '1':
                    ...
                    try {
                        ...
                        std::cin >> value;
                        if (x_1 < 0 || y_1 < 0) {
                            image_2.rdraw_rectangle(x_1, y_1, x_2, y_2, 0, 0, value);
                        }
                        else {
                            image_2.rdraw_rectangle(x_1, y_1, x_2, y_2, x_1, y_1, value);
                        }
                        std::cout << "Okey.." << std::endl;
                    }
                    catch (const std::out_of_range& err) {
